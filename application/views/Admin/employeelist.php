...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Udaan Admin-Employee List</title>
        <!-- App favicon -->
                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive"> 
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<td><center><?php echo $employee_list->RE_EMPLOYEED_ID; ?></center></td>
										<td><center><?php echo $employee_list->RE_PASSWORD; ?></center></td>
										<td><center><?php echo $employee_list->RE_MOBILE_NUMBER; ?></center></td>
										<td><center><?php echo $employee_list->RE_DIVISION; ?></center></td>						
										<td><center><?php echo $employee_list->RE_DESIGNATION; ?></center></td> 						
