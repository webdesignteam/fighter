...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Activity Group</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Activity Group</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
                              <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Group</button> </p>	
