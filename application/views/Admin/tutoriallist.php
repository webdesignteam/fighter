...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Udaan Admin-Tutorial List</title>
        <!-- App favicon -->
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
					<?php // echo "<pre>";print_r($tutorial_list); ?>
                                <div class="card-box table-responsive"> 
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										foreach($tutorial_list as $tutorial_list) {?>
                                            <tr>
									<td><center><?php echo $counter=$counter+1; ?></center></td>
									<td><center><?php echo $tutorial_list->TUTORIAL_TITLE; ?></center></td>
									<td><center><?php echo $tutorial_list->SERIES_TITLE; ?></center></td>
									<td><center><?php echo $tutorial_list->TUTORIAL_STATUS; ?></center></td>						
									<td><center> <a href="<?php echo base_url().'admin/edit_tutorial/'.$tutorial_list->TUTORIAL_ID;?>" ><i class="far fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
											<a href="<?php //echo base_url().'admin/delete_series/'.$tutorial_list->TUTORIAL_ID; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
