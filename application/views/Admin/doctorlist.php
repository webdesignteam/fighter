                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
                              <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Doctor</button> </p>	
                                <div class="card-box table-responsive"> 
							<?php //echo"<pre>";print_R($doctorlist[0]->BUILDING_NAME); ?>
									...
									<td><center><?php echo $doctorlist->DOCTOR_CODE; ?></center></td>
									<td><center><?php echo $doctorlist->SFACODE; ?></center></td>
									<td><center><?php echo $doctorlist->DOCTOR_NAME; ?></center></td>
									<td><center><?php echo $doctorlist->GRADECODE; ?></center></td>
									<td><center><?php echo $doctorlist->QUALIFICATION; ?></center></td>
									<td><center><?php echo $doctorlist->HOSPITAL_NAME; ?></center></td>
									<td><center><?php echo $doctorlist->BUILDING_NAME; ?></center></td>
									<td><center><?php echo $doctorlist->AREA; ?></center></td>
									<td><center><?php echo $doctorlist->CITY; ?></center></td>
									<td><center><?php echo $doctorlist->MOBILENO; ?></center></td>
									<td><center><?php echo $doctorlist->SPECIALITY; ?></center></td>								
