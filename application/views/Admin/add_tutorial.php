                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 offset-1">
                                ...
                                <div class="card-box">                                  
                                    ...
                                    <form action="#" name="add_tutorial" id="add_tutorial" enctype="multipart/form-data" accept-charset="utf-8" >                               
											
									<div class="form-group">
									<label for="userName">Tutorial Title<span class="text-danger">*</span></label>
										<input type="text" name="TUTORIAL_TITLE" id="TUTORIAL_TITLE" parsley-trigger="change" 	required placeholder="Enter TUTORIAL_TITLE" class="form-control" />
									</div> 									
									
									<div class="form-group">
									<label for="userName">Tutorial Descriptions<span class="text-danger">*</span></label>
										<input type="text" name="TUTORIAL_DESC" id="TUTORIAL_DESC" parsley-trigger="change" 	required placeholder="Enter Series TUTORIAL_DESC" class="form-control" />
									</div> 								
									...
									{
									?><option value="<?php echo $result['result'][$i]['SERIES_ID']; ?>"><?php echo $result['result'][$i]['SERIES_TITLE']; ?></option> <?php
									}
									?>
									</select>
									</div> 
	...
	$(function ()
	{
		$('#add_tutorial').validate({
			...
			{ 
				$.ajax({
				type: 'post',
				url: '<?php echo base_url();?>admin/add_tutorial',
				data: $('#add_tutorial').serialize(),
