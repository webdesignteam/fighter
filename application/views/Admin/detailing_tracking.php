...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Standard Detailing Tracking </title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Standard Detailing</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Standard Detailing Tracking</a></li>
                                       <li class="breadcrumb-item active">Standard Detailing Tracking</li>
                                    </ol>
                        ...
                        <div class="row">
							...
							<?php //echo"<pre>";print_R($notificationlist); ?>
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										foreach($detailing_tracking as $detailing_tracking) {?>
                                            <tr>
									<td><center><?php echo $counter=$counter+1; ?></center></td>
									<td><center><?php echo $detailing_tracking->DETAILING_ID; ?></center></td>
									<td><center><?php echo $detailing_tracking->NAME; ?></center></td>
									<td><center><?php echo $detailing_tracking->FILE_FORMAT; ?></center></td>
									<td><center><?php echo $detailing_tracking->FILE_TYPE; ?></center></td>
									<td><center><?php echo $detailing_tracking->BRAND_NAME; ?></center></td>
									<td><center><?php echo $detailing_tracking->DIVISION_NAME; ?></center></td>
									<td><center><?php echo $detailing_tracking->DOCTOR_NAME; ?></center></td>
									<td><center><?php echo $detailing_tracking->GRADECODE; ?></center></td>
									<td><center><?php echo  $detailing_tracking->HOSPITAL." ". $detailing_tracking->BUILDING." ".$detailing_tracking->STREET_NAME." ".$detailing_tracking->AREA." ".$detailing_tracking->CITY; ?></center></td>								
