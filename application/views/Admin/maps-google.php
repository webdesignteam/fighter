...
<html>
    ...
    <body>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Google Maps</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-box">
                                    <h4 class="m-t-0 m-b-20 header-title"><b>Polygons</b></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card-box">
                                    <h4 class="m-t-0 m-b-20 header-title"><b>Routes</b></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card-box">
                                    <h4 class="m-t-0 m-b-20 header-title"><b>Context menu (right click on map)</b></h4>
        ...
        <!-- main file -->
        <script src="<?php echo base_url().'theme/plugins';?>/gmaps/gmaps.min.js"></script>

        <!--  Init -->
        <script src="<?php echo base_url().'theme/assets';?>/pages/jquery.gmaps.js"></script>
