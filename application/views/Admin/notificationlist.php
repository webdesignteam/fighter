...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Notification List </title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
                              <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Notification</button> </p>	
							...
							<?php //echo"<pre>";print_R($notificationlist); ?>
									...
									<td><center><?php echo $notificationlist->NOT_CODE; ?></center></td>
									<td><center><?php echo $notificationlist->NOT_DATE; ?></center></td>
									<td><center><?php echo $notificationlist->NOT_TITLE; ?></center></td>
									<td><center><?php echo $notificationlist->NOT_MESSAGE; ?></center></td>
									<td><center><?php echo $notificationlist->NOT_LARGE_ICON; ?></center></td>
									<td><center><?php echo $notificationlist->CAT_NAME; ?></center></td>
									<td><center><?php echo $notificationlist->CAT_DESC; ?></center></td>								
