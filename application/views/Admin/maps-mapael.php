...
<html>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Mapael Maps</h4>
        ...
        <script src="<?php echo base_url().'theme/plugins';?>/jquery-mapael/raphael-min.js"></script>
        <script src="<?php echo base_url().'theme/plugins';?>/jquery-mapael/jquery.mapael.min.js"></script>
        <script src="<?php echo base_url().'theme/plugins';?>/jquery-mapael/maps/world_countries.min.js"></script>
        <script src="<?php echo base_url().'theme/plugins';?>/jquery-mapael/maps/usa_states.min.js"></script>
        <script src="<?php echo base_url().'theme/assets';?>/pages/jquery.mapael-map.init.js"></script>
