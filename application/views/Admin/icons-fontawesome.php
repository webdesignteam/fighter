                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <div class="card-box">
                                        <section>
                                            <h4 class="page-header header-title mb-4"><b>41 New Icons in 4.7 </b><span class="badge badge-success">New</span></h4>
                                        ...
                                        <section>
                                            <h4 class="header-title mb-4 mt-5"><b>30 New Icons in 4.6.3 </b></h4>
                                            <div class="icon-list-demo row">
                                        ...
                                        <section>
                                            <h4 class="header-title mb-4 mt-5"><b>20 New Icons in 4.5 </b></h4>
                                            <div class="icon-list-demo row">
                                        ...
                                        <section>
                                            <h4 class="header-title mb-4 mt-5"><b>66 Icons in 4.4 </b></h4>
                                            <div class="icon-list-demo row">
                                        ...
                                        <section>
                                            <h4 class="header-title mb-4 mt-5"><b>40 Icons in 4.3 </b></h4>
                                        ...
                                        <section id="new-icons">
                                            <h4 class="header-title mb-4 mt-5"><b>40 Icons in 4.2</b></h4>
                                            <div class="icon-list-demo row">
                                        ...
                                        <section id="web-application">
                                            <h4 class="header-title mb-4 mt-5"><b>Web Application</b></h4>
                                            <div class="icon-list-demo row">
                                        ...
                                        <section id="file-type">
                                            <h4 class="header-title mb-4 mt-5"><b>File Type Icons</b></h4>
                                        ...
                                        <section id="spinner">
                                            <h4 class="header-title mb-4 mt-5"><b>Spinner Icons</b></h4>
                                        ...
                                        <section id="form-control">
                                            <h4 class="header-title mb-4 mt-5"><b>Form Control Icons</b></h4>
                                        ...
                                        <section id="currency">
                                            <h4 class="header-title mb-4 mt-5"><b>Currency Icons</b></h4>
                                        ...
                                        <section id="text-editor">
                                            <h4 class="header-title mb-4 mt-5"><b>Text Editor Icons</b></h4>
                                        ...
                                        <section id="directional">
                                            <h4 class="header-title mb-4 mt-5"><b>Directional Icons</b></h4>
                                        ...
                                        <section id="video-player">
                                            <h4 class="header-title mb-4 mt-5"><b>Video Player Icons</b></h4>
                                        ...
                                        <section id="brand">
                                            <h4 class="header-title mb-4 mt-5"><b>Brand Icons</b></h4>
                                        ...
                                        <section id="medical">
                                            <h4 class="header-title mb-4 mt-5"><b>Medical Icons</b></h4>
