...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Activity Planning</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Activity Planning</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Activity</a></li>
                                       <li class="breadcrumb-item active">Activity Planning</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
							 <a href="<?php echo base_url().'Webadmin/add_planning';?>" > <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Activity Planning</button></a>
                               </p>	
                                <div class="card-box table-responsive"> 
							<?php //echo"<pre>";print_R($activity_planning); ?>
...
<?php 
$counter=0;					
foreach($activity_planning as $activity_planning) {?>
<tr>

<td><center><?php echo $counter=$counter+1; ?></center></td>
<td><center><?php echo $activity_planning->PLAN_ID; ?></center></td>
<td><center><?php echo $activity_planning->ACTIVITY_NAME; ?></center></td>	
<td><center><?php echo $activity_planning->PLANNED_DATE; ?></center></td>			
<td><center><?php echo $activity_planning->DOCTOR_NAME; ?></center></td>
<td><center><?php echo $activity_planning->SPECIALITY; ?></center></td>
<td><center><?php echo $activity_planning->DOCTOR_CODE; ?></center></td>
<td><center><?php echo $activity_planning->HOSPITAL_NAME; ?></center></td>
<td><center><?php echo $activity_planning->QUALIFICATION; ?></center></td>
<td><center><?php echo $activity_planning->BUILDING_NAME; ?></center></td>
<td><center><?php echo $activity_planning->AREA; ?></center></td>
<td><center><?php echo $activity_planning->CITY; ?></center></td>
<td><center><?php echo $activity_planning->MOBILENO; ?></center></td>
