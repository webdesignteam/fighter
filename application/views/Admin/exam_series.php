                        ...
                        <div class="row">
							...
							<?php  // echo "<pre>";print_r($exam_series);?>
                                <div class="card-box table-responsive"> 
									...
									<thead>
										<tr>
											<th><center>Series ID</center></th>
											<th><center>Title</center></th>
											<th><center>Exam</center></th>										
										</tr>
									</thead>
									<tbody>
									<?php $status ='Allow'; $set=''; $count=0;?>
									<?php  foreach($exam_series as $exam_series) {?>
										<tr>
											<td><center><?php echo $exam_series['SERIES_ID']; ?></center></td>
											<td><center><?php echo $exam_series['SERIES_TITLE']; ?></center></td>
											<td><center>
...
if($exam_series['EXAM_STAUS']==0)
{
	$count=$count+1;
											...
											?>
											<?php   $exam_series['EXAM_STAUS'] ;if(!$exam_series['EXAM_STAUS']) { 
if($count==1)
{
	?> 	<a href="<?php echo base_url().'admin/StartExam' ?>/<?php echo $SERIES_ID; ?>" > <button type="button" class="btn btn-success">Attend Exam</button></a><?php
	
}
else
{ ?>
		<!-- <a href="<?php echo base_url().'admin/StartExam' ?>/<?php echo $SERIES_ID; ?>" > <button  disabled type="button" class="btn btn-success">Attend Exam</button></a> --> <?php
}

											?>
			
											<?php } else { ?> <button type="button" class="btn btn-success">Passed</button><?php  } ?>
											</center></td>
										</tr>
									<?php } ?>
