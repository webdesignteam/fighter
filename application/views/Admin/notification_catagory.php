...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Notification Catagory</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Notification Catagory</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Notification</a></li>
                                       <li class="breadcrumb-item active">Notification Catagory</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-12">
							    <p class="pull-right">              
							   <a href="<?php echo base_url().'Webadmin/add_notification_cat';?>" > <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Notification Catagory</button></a></p>		
                                <div class="card-box table-responsive"> 
							<?php //echo"<pre>";print_R($notification_catagory); ?>
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th>CAT NAME</th>
                                            <th>CAT DESC</th>
											<th>CAT_CREATED_TS</th>
											<th>CAT_UPDATED_TS</th>
                                            <th>ACTION</th>
										...
										foreach($notification_catagory as $notification_catagory) {?>
                                            <tr>
									<td><center><?php echo $counter=$counter+1; ?></center></td>
									<td><center><?php echo $notification_catagory->CAT_NAME; ?></center></td>
									<td><center><?php echo $notification_catagory->CAT_DESC; ?></center></td>								
									<td><center><?php echo $notification_catagory->CAT_CREATED_TS; ?></center></td>								
									<td><center><?php echo $notification_catagory->CAT_UPDATED_TS; ?></center></td>								
