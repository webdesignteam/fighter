...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Activity Execution</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Activity Execution</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Activity</a></li>
                                       <li class="breadcrumb-item active">Activity Execution</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
                              <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Activity Execution</button> </p>	
                                <div class="card-box table-responsive"> 
							<?php ///echo"<pre>";print_R($activity_execution); ?>
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
										   ...
										   <tbody>
                                    	<?php  $counter=0;	
										foreach($activity_execution as $activity_execution) {?>
                                            <tr>
											<td><center><?php echo $counter=$counter+1; ?></center></td>
									<td><center><?php echo $activity_execution->EXECUTE_ID; ?></center></td>
									<td><center><?php echo $activity_execution->ACTIVITY_ID; ?></center></td>
									<td><center><?php echo $activity_execution->PLANNED_DATE; ?></center></td>
									<td><center><?php echo $activity_execution->DOCTOR_CODE; ?></center></td>
									<td><center><?php echo $activity_execution->EXECUTED_DATE; ?></center></td>
									<td><center><?php echo $activity_execution->PLAN_ID; ?></center></td>
									<td><center><?php echo $activity_execution->SFACODE; ?></center></td>
									<td><center><?php echo $activity_execution->DOCTOR_NAME; ?></center></td>
									<td><center><?php echo $activity_execution->GRADECODE; ?></center></td>
									<td><center><?php echo $activity_execution->CLINIC/HOSPITAL_NAME; ?></center></td>
									<td><center><?php echo $activity_execution->QUALIFICATION; ?></center></td>
									<td><center><?php echo $activity_execution->HOUSE/BUILDING_NAME; ?></center></td>
									<td><center><?php echo $activity_execution->AREA; ?></center></td>
									<td><center><?php echo $activity_execution->CITY; ?></center></td>
									<td><center><?php echo $activity_execution->MOBILENO; ?></center></td>
									<td><center><?php echo $activity_execution->SPECIALITY; ?></center></td>
