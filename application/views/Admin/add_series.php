                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 offset-1">
                                ...
                                <div class="card-box">                                  
                                    ...
                                    <form action="#" name="add_series" id="add_series" enctype="multipart/form-data" accept-charset="utf-8" >                               
											
									<div class="form-group">
									<label for="userName">Series Title<span class="text-danger">*</span></label>
										<input type="text" name="SERIES_TITLE" id="SERIES_TITLE" parsley-trigger="change" 	required placeholder="Enter Series Title" class="form-control" />
									</div> 									
									
									<div class="form-group">
									<label for="userName">Series Descriptions<span class="text-danger">*</span></label>
										<input type="text" name="SERIES_DESC" id="SERIES_DESC" parsley-trigger="change" 	required placeholder="Enter Series Descriptions" class="form-control" />
									</div> 								

									<div class="form-group">
									<label for="userName">Start Date<span class="text-danger">*</span></label>
										<input type="date" name="START_DATE" id="START_DATE" parsley-trigger="change" 	required  class="form-control" />
									</div> 									
									
									<div class="form-group">
									<label for="userName">End Date<span class="text-danger">*</span></label>
										<input type="date" name="END_DATE" id="END_DATE" parsley-trigger="change" 	required  class="form-control" />
									</div> 
								<div class="form-group text-right m-b-0">
									<input type="submit" class="btn btn-default" name="submit" id="submit" value="Add Series" />
