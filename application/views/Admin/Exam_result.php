...
<html>
    <head>
        <meta charset="utf-8" />
        <title>DiaGyan-Exam Result</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
							...
							<?php if($exam_status ) { ?>
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th><center>Obatained Score</center></th>
										...
										<td><center><?php echo $Exam_result['SCORE']; ?></center></td>									
										</tr>
										<?php } ?>
										
							<?php  foreach($ExamReport as $ExamReport) {?>
										<tr>
										<td><center>16</center></td>
										<td><center><?php //echo $ExamReport->RESULT_DATE; ?></center></td>
										<td><center><?php //echo $ExamReport->ANWERED_QUESTION; ?></center></td>
										<td><center><?php // echo $ExamReport->OBTAINED_MARK; ?></center></td>									
										<td><center><?php echo $ExamReport->OBTAINED_MARK."/".$ExamReport->TOTAL_MARKS; ?></center></td>									
							...
							<?php } else { echo "<center><h4>You Have not Submitted Exam Questionaires to get A Result ..!! Please Submit Questionaries First </h4></center>"; } ?>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
