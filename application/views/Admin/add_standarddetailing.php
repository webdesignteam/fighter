...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Abstack - Add Standard Detailing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Add Standard Detailing</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Standard Detailing</a></li>
                                        <li class="breadcrumb-item"><a href="#">Add Standard Detailing</a></li>
                            ...
                            <div class="col-lg-10 offset-1">
                                ...
                                <div class="card-box">                                  
                                    ...
                                    <form action="#" name="add_standarddetailing" id="add_standarddetailing" enctype="multipart/form-data" accept-charset="utf-8" >                               
									<div class="form-group">
									<label for="userName">Select Brand<span class="text-danger">*</span></label>
									...
									$url = base_url().'Webadmin/GetAllBrands';
									$result = file_get_contents($url, false, $context);
									$result= json_decode($result, true); 
									for($i=0;$i<count($result['result']);$i++)
									{
									?><option value="<?php echo $result['result'][$i]['ID']; ?>"><?php echo $result['result'][$i]['BRAND_NAME']; ?></option> <?php
									}
									?>
									</select>
									</div> 
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.28.2/sweetalert2.all.js"></script>
	...
	$(function ()
	{
		$('#add_standarddetailing').validate({
			rules: 
			{
				"format":
				{
  ...
  fd.append('activity_id ',$('#activity_id').val());
				...
				$.ajax({
				type: 'post',
				url: '<?php echo base_url();?>Webadmin/add_standarddetailing',
    ...
    processData: false,   
				success: function(data)
				{
					...
					window.location = "<?php echo base_url().'Webadmin/stand_detailing'; ?>";
					}
					else
					{
						swal({
