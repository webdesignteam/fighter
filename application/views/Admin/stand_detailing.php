...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Genx-Standard Detailing </title>
                ...
                <div class="content">
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Standard Detailing</a></li>
                                       <li class="breadcrumb-item active">Add Standard Detailing</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-12">
								<p class="pull-right">              
							   <a href="<?php echo base_url().'Webadmin/add_standarddetailing';?>" > <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Standard Detailing</button></a></p>	
							...
							<?php //echo"<pre>";print_R($notificationlist); ?>
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										foreach($stand_detailing as $stand_detailing) {?>
                                            <tr>
								<!--	<td><center><?php echo $counter=$counter+1; ?></center></td>-->
									<td><center><?php echo $stand_detailing->DETAILING_ID; ?></center></td>
									<td><center><?php echo $stand_detailing->NAME; ?></center></td>
									<td><center><?php echo $stand_detailing->FILE_FORMAT; ?></center></td>
									<td><center><?php echo $stand_detailing->FILE_TYPE; ?></center></td>
									<td><center><?php echo $stand_detailing->BRAND_NAME; ?></center></td>
									<td><center><?php echo $stand_detailing->BRAND_CODE; ?></center></td>
									<td><center><?php echo $stand_detailing->DIVISION_NAME; ?></center></td>
									<td><center><?php echo $stand_detailing->DIVISION_CODE; ?></center></td>								
