...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Udaan Admin-Question List</title>
        <!-- App favicon -->
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
							<p class="pull-right">
                             <a href="<?php echo base_url(); ?>admin/add_questions" > <button type="button" class="btn btn-success btn-rounded waves-light waves-effect w-md">Add Question</button> </a></p>	
                                <div class="card-box table-responsive"> 
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    	...
                                    	<?php 
                                               $counter=0;										
										//echo "<pre>";print_r($question_list);
										foreach($question_list as $question_list) {?>
                                            <tr>
											<td><center><?php echo $counter=$counter+1; ?></center></td>
											<td><center><?php echo $question_list['SERIES_TITLE']; ?></center></td>
											<td><center><?php echo $question_list['QUESTION_TEXT'] ?></center></td>
											<td><center><?php echo $question_list['QUESTION_OPTIONS'][0]['OPTION_TEXT']; ?></center></td>
											<td><center><?php echo $question_list['QUESTION_OPTIONS'][1]['OPTION_TEXT']; ?></center></td>
											<td><center><?php echo $question_list['QUESTION_OPTIONS'][2]['OPTION_TEXT']; ?></center></td>						
											<td><center><?php echo $question_list['QUESTION_OPTIONS'][3]['OPTION_TEXT']; ?></center></td>						
											<td><center><?php echo $question_list['QUESTION_ANSWER_ID']; ?></center></td>						
