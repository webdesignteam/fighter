									...
									<div class="card custom-card">
                                        <div class="card-header" id="headingOne">
										 <div class="row">
                                          <div class="col-lg-6">
                                            <h4 class="m-0">
                                                <a href="#collapseOne<?php echo $counter; ?>" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne<?php echo $counter; ?>">
                                                  <?php echo $tutorial->TUTORIAL_TITLE; ?>
                                                </a>
                                            </h4>
											</div>
											<div class="col-lg-6">
											<h4 class="page-title float-right"><a href="<?php  echo base_url().'Employee/tutorial_series'?>" > <button type="button" class="btn btn-exam btn-sm">Back</button></a></h4>
											</div>
											</div>
