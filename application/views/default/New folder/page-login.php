...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Udaan - Employee Registration</title>
										...
										<div class="form-group row m-b-20">
                                            ...
                                            <div class="form-group row m-t-10">
                                                <div class="col-12">
												 ...
												 <input class="btn btn-success btn-rounded w-md pull-right" name="submit" type="submit" value="Register" />
												 
												 
<div class="form-group row m-t-10">
	<div class="col-12">
	<a href="<?php echo base_url().'Employee/login';?>" > <input class="btn btn-success btn-rounded w-md pull-left"  type="button" value="Login" /> </a>
	</div>
</div>
										 ...
										 <div class="row">
    <div class="col-sm-12">
<p> If you are already registered ..Please click on Login </p>
    </div>   
