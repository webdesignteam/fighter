      ...
      <!-- HOME -->
         <div class="container-fluid" style="padding: 0px;">
            <div class="row">
               ...
               <div class="col-sm-6 login-box-right text-center">
               <img src="<?php echo base_url().'employee_assets/assets';?>/images/logo.svg" alt="Fighter" style="height: 160px;">
                  <div class="login-box ">
                     <p class="login-box-title">Sign in to continue</p>
                     <form name="login" id="login" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                           <div class="col-12">
                              <input type="password" class="form-control" name="emp_pass" id="emp_pass" required placeholder="Enter Your Password" />
                           </div>
                        </div>
                        <div class="form-group row">
                           <div class="col-12">
                              <input class="btn btn-login btn-block" name="submit" type="submit" value="SIGN IN" />
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-12">
                              <p>Dont't have an account? <a href="<?php echo base_url().'Employee/register';?>" >Sign Up</a></p>
